...
function Criar({ forCompany = false, bare = false }: { forCompany?: boolean; bare?: boolean } = {}) {
  ...
  const [regulation, setRegulation] = useState<string>(
    `REGULAMENTO OFICIAL DO DESAFIO DE PALPITES\n\n1. Do Objeto\n\nEste regulamento dispõe sobre as normas e condições de participação no desafio de palpites intitulado "Brasil x Escócia: Acerte os palpites e ganhe um jantar imperdível!", doravante denominado simplesmente "Desafio", promovido pela Casa di Napoli Pizzaria, no contexto da Copa do Mundo 2026.\n\n2. Da Participação\n\nA participação neste Desafio é voluntária e totalmente gratuita, não exigindo qualquer pagamento, aposta com dinheiro real ou compra de produtos para a inscrição. Podem participar pessoas físicas, residentes e domiciliadas em território nacional, com idade igual ou superior a 18 (dezoito) anos completos no ato da inscrição. A participação está condicionada à aceitação irrestrita e obrigatória de todos os termos e condições estabelecidos neste regulamento.\n\n3. Do Período\n\nO Desafio terá vigência até o dia 24 de junho de 2026. O prazo final e improrrogável para o registro de palpites na plataforma encerra-se às 16:00 (horário de Brasília) do dia 24/06/2026. Palpites enviados após este horário não serão computados pela organização.\n\n4. Da Mecânica\n\nPara participar, o usuário deverá acessar a plataforma oficial, realizar seu cadastro e registrar seus palpites para o evento esportivo especificado. A pontuação será atribuída de acordo com a exatidão das previsões registradas sobre o resultado da partida entre Brasil e Escócia, conforme os critérios de pontuação estabelecidos no sistema da plataforma no momento do palpite.\n\n5. Da Premiação\n\nO participante que obtiver o melhor desempenho, conforme os critérios de pontuação e desempate, fará jus a 01 (um) jantar oferecido pela Casa di Napoli Pizzaria. Os detalhes sobre o que está incluso no jantar e as condições de usufruto (como data e horário para reserva) serão informados diretamente ao vencedor pela empresa organizadora. O prêmio é pessoal, intransferível e não poderá ser convertido em dinheiro.\n\n6. Dos Critérios de Desempate\n\nNa hipótese de igualdade de pontuação entre dois ou mais participantes, serão aplicados os seguintes critérios de desempate, nesta ordem de prioridade:\n\n6.1. Maior número de acertos nos palpites registrados.\n\n6.2. Maior quantidade de missões concluídas na plataforma.\n\n6.3. Maior número de novos usuários convidados que realizaram o cadastro completo através do link do participante.\n\n6.4. Ordem cronológica de envio do palpite, premiando aquele que registrou a previsão primeiro.\n\n6.5. Sorteio eletrônico realizado pela organização do evento.\n\n7. Da Entrega do Prêmio\n\nA responsabilidade exclusiva pela entrega, qualidade e cumprimento da promessa de premiação é da Casa di Napoli Pizzaria, na qualidade de organizadora. O vencedor será contatado através dos dados fornecidos no cadastro para instruções sobre a retirada ou usufruto do prêmio.\n\n8. Das Disposições Gerais\n\n8.1. A plataforma Desafio dos Palpites atua única e exclusivamente como intermediadora tecnológica, fornecendo a infraestrutura digital para o registro de palpites e processamento de dados.\n\n8.2. A plataforma não oferece garantias sobre a entrega de prêmios prometidos por terceiros, não possuindo responsabilidade legal sobre a idoneidade do organizador ou a efetiva entrega do jantar.\n\n8.3. O organizador (Casa di Napoli Pizzaria) é o único e legítimo responsável civil e criminal pela premiação, logística de entrega e eventuais danos decorrentes da execução deste Desafio.\n\n8.4. A plataforma reserva-se o direito de remover desafios, suspender ou excluir contas de usuários em caso de suspeita de fraude, uso de scripts, perfis falsos, conduta inadequada ou qualquer tentativa de manipulação dos resultados.\n\n9. Do Foro\n\nPara dirimir quaisquer questões oriundas deste regulamento que não puderem ser resolvidas administrativamente, fica eleito o foro da comarca da sede da empresa organizadora, com renúncia expressa a qualquer outro, por mais privilegiado que seja.`
  );
